...
start = "2013-09-01 00:00:01"
#start = start.strftime("%Y-%m-%d %H:%M:%S")

response = br.open("https://account.celltracktech.com/accounts/login")
br.form = list(br.forms())[0]
br.form["username"] = "rroy"
br.form["password"] = "RoyFirstWind"
response = br.submit()
...
br.open('https://account.celltracktech.com/data/download/1741/') #Davis
...
br.open('https://account.celltracktech.com/data/download/1752/') #Onawa
